...
import FormsElements from '../../pages/forms/elements/Question';
import FormsValidation from '../../pages/forms/validation';
import FormsWizard from '../../pages/forms/wizard';
import Today from '../../pages/tables/static/Today';
...
import Management from '../../pages/management/Services';
import Product from '../../pages/product';
import Package from '../../pages/package/Availability';
...
import Service from '../../pages/management/Services';
import Availability from '../../pages/package/Availability';
import Question from '../../pages/forms/elements/Question';
import Accepted from '../../pages/core/Accepted/Accepted';
import ViewService from '../../pages/ViewService/ViewService';
import UserDetails from '../../pages/UserDetails/UserDetais';
import Appoinment from '../../pages/Appoinment/Appoinment';
import UserList from  '../../pages/Admin Panel/User List/UserList';
import Challenges from '../../pages/Admin Panel/Challenges/Challenges';
import Rewards from '../../pages/Admin Panel/Rewards/Rewards';
              ...
              <TransitionGroup>
                ...
                >
                  <Switch>
                    ...
                    <Route path="/app/Services" exact component={Service} />
                    ...
                    <Route path="/app/Availability" exact component={Availability} />
                    <Route path="/app/forms" exact render={() => <Redirect to="/app/forms/elements" />} />
                    <Route path="/app/Question" exact component={Question} />
                    ...
                    <Route path="/app/Today" exact component={Today} />
                    ...
                    <Route path="/app/Appoinment" exact component={Appoinment} />
                    <Route path="/app/core/colors" exact component={CoreColors} />
                    <Route path="/app/core/grid" exact component={CoreGrid} />
                    <Route path="/app/Accepted" exact component={Accepted} />
                    <Route path="/app/ViewService" exact component={ViewService} />
                    <Route path="/app/UserDetails" exact component={UserDetails} />

                    //Admin Routes
                    
                    <Route path="/app/admin/userlist" exact component={UserList} />
                    <Route path="/app/admin/challenges" exact component={Challenges} />
                    <Route path="/app/admin/rewards" exact component={Rewards} />
